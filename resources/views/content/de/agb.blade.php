...
--}}
                <h4 class="mb-3 mt-5">1. Präambel </h4>
                <p class="mt-5">
                ...
                <h4 class="mb-3 mt-5">2. Allgemeines und Anwendungsbereich</h4>
                <p class="mt-5">
                ...
                <h4 class="mb-3 mt-5">3. Gegenstand Lubey Trade, dem Online-Marktplatz</h4>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h4 class="mb-3 mt-5">4. Beziehungen zwischen den Nutzern des Online-Marktplatzes und der Lubey AG als Be-treiber des Online-Marktplatzes („Nutzungsvertrag“)</h4>
                <h5 class="mt-4">4.1 Gegenstand Nutzungsvertrag und Laufzeit </h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.2 Vertragsschluss</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.3 Registrierung und Nutzerkonto</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.4 Transaktionsentgelt</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.5 Allgemeine Pflichten des Nutzers</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.6 Vertragsstrafe</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.7 Prüfungs- und Korrekturrechte der Lubey AG</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.8 Interventionsrechte der Lubey AG</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.9 Schadenersatzpflicht der Nutzer; Ausschluss von Nutzern</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.10 Zugangs- und Verfügungsbeschränkungen hinsichtlich der Nutzung des Online-Marktplatzes</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.11 Haftung der Lubey AG</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.12 Haftungsausschluss für Angaben der Nutzer</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.13 Kommunikation zwischen den Nutzern und der Lubey AG als Betreiber des Online-Marktplatzes</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.14 Zahlungsbedingungen und Verzug</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">4.15 Lizenzvereinbarungen, Urheber- und Nutzungsrechte</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h4 class="mb-3 mt-5">5. Beziehungen der Nutzer des Online-Marktplatzes untereinander</h4>
                <h5 class="mt-4">5.1 Gegenstand Hauptvertrag</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">5.2 Pflichten der Anbieter</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">5.3 Pflichten der Bieter </h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">5.4 Vertragsbestimmungen und Vertragsbestandteile in Hauptverträgen</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">5.6 Zustandekommen der Hauptverträge bei der Spot-Auktion</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">5.7 Erfüllung Hauptvertrag</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h5 class="mt-4">5.8 Abbruch von Vermarktungen auf Antrag der Nutzer und Rücknahme von Geboten</h5>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h4 class="mb-3 mt-5">6. Bewertungen</h4>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
                ...
                <h4 class="mb-3 mt-5">7. Datenschutz</h4>
                <p class="mt-5">
                ...
                <h4 class="mb-3 mt-5">8. Änderungsvorbehalt</h4>
                <p class="mt-5">
                    <span class="text-important">(1)</span>&nbsp;
        ...
        <div class="row justify-content-center content-list mt-5">
            <div class="col-md-10 ">
                ...
                <ul class="mt-4 list-unstyled">
                    ...
                    <li><h4 class="mb-3 mt-5">3. Gegenstand von Lubey Trade, dem Online-Marktplatz</h4>
                        <ol class="brackets">
                            <li>Lubey Trade ist ein Online-Marktplatz zum Abschluss von Verträgen über den Kauf von Abfällen und
                                ...
                                <p class="mt-5">Gem. § 5 Abs. 2 KrWG kann die Bundesregierung durch Rechtsverordnung mit Zustimmung des Bundesrates nach Maßgabe der in Absatz 1 genannten
                                    Anforderungen die
                    ...
                    <li><h4 class="mb-3 mt-5">4. Beziehung zwischen der Vergabestelle als Nutzerin des Online-Marktplatzes und der Lubey AG als Betreiber des Online-Marktplatzes</h4>
                        <ul class="list-unstyled">
                            <li><h5 class="mt-4">4.1 Vertragsgegenstand (Nutzungsvertrag)/Vertragsschluss</h5>
                                <ol class="brackets">
                            ...
                            <li><h5 class="mt-4">4.2 Registrierung und Nutzerkonto</h5>
                                <ol class="brackets">
                            ...
                            <li><h5 class="mt-4">4.3 Transaktionsentgelt</h5>
                                <ol class="brackets">
                            ...
                            <li><h5 class="mt-4">4.4 Pflichten der Vergabestelle</h5>
                                <ol class="brackets">
                            ...
                            <li><h5 class="mt-4">4.5 Spezielle Pflichten der Vergabestelle bzgl. der Nutzung der Vergabeplattform</h5>
                            ...
                            <li><h5 class="mt-4">4.6 Vertragsstrafe</h5>
                                <ol class="brackets">
                            ...
                            <li><h5 class="mt-4">4.7 Prüfungsrechte der Lubey AG</h5>
                                <ol class="brackets">
                                    <li>Die Lubey AG ist – soweit dies zur Einhaltung ihrer abfallrechtlichen Pflichten als Makler erforderlich ist – berechtigt, die
                                        ...
                                        <p class="mt-5">Die Lubey AG wird in diesem Falle die Vergabestelle auffordern, entsprechende Nachweise für ihre Einordnung vorzulegen oder
                                            entsprechende
                                            Korrekturen
                                            vorzunehmen.</p>
                                    </li>
                            ...
                            <li><h5 class="mt-4">4.8 Zugangs- und Verfügungsbeschränkungen hinsichtlich der Nutzung des Online-Marktplatzes</h5>
                                <ol class="brackets">
                            ...
                            <li><h5 class="mt-4">4.9 Haftung der Lubey AG</h5>
                                <ol class="brackets">
                            ...
                            <li><h5 class="mt-4">4.10 Haftungsausschluss für Angaben der Nutzer (Vergabestelle und Bieter)</h5>
                                <ol class="brackets">
                            ...
                            <li><h5 class="mt-4">4.11 Kommunikation zwischen der Vergabestelle und der Lubey AG als Betreiber des Online-Marktplatzes</h5>
                                <ol class="brackets">
                            ...
                            <li><h5 class="mt-4">4.12 Lizenzvereinbarungen, Urheber- und Nutzungsrechte</h5>
                                <ol class="brackets">
                    ...
                    <li><h4 class="mb-3 mt-5">5. Beziehungen der Nutzer des Online-Marktplatzes untereinander</h4>
                        <ul class="list-unstyled">
                            <li><h5 class="mt-4">5.1 Vertragsgegenstand („Hauptvertrag“)</h5>
                                <ol class="brackets">
                            ...
                            <li><h5 class="mt-4">5.2 Abbruch, Unterbrechung oder Zurückversetzung von Ausschreibungen mit elektronischer Auktion</h5>
                                <ol class="brackets">
                    ...
                    <li><h4 class="mb-3 mt-5">6. Datenschutz</h4>
                        <p class="mt-5">Die Daten der Nutzer werden nach Beendigung des Vertragsverhältnisses unter Berücksichtigung der gesetzlichen Aufbewahrungsfristen
                            gelöscht. Weitere
