...
@section('content')
	<section class="h-40 md:h-72 bg-header-trade z-0 bg-cover bg-hdigit">
		<div class="container mx-auto px-6 pt-10 md:pt-20">
			<p class="text-3xl md:text-5xl font-semibold text-white">Lubey</p>
			<h2 class="text-4xl md:text-7xl font-semibold text-white">INDIVIDUAL</h2>
		</div>
    </section>

    <section class="container relative mx-auto mt-10 xl:mt-0 px-6 z-10">
