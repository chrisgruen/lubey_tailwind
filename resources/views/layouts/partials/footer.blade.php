<footer>
    {{--  <div style="background: linear-gradient(180deg, #479FDA 0%, #07468F 80%)" class="text-white  text-sm">
          <div class="container mx-auto px-6 pt-10 pb-6">
          </div>
      </div>
    --}}
    <div style="background:#07468F" class="text-white text-sm">
        <div class="container mx-auto px-6 pt-10 pb-6">
            <div class="flex flex-wrap">
                <div class="w-full md:w-1/4 text-center md:text-left ">
                    <h5 class=" mb-6 font-bold">Lubey AG</h5>
                ...
                <div class="w-full md:w-1/4 text-center md:text-left ">
                    <h5 class=" mb-6 font-bold">Produkte</h5>
                    <ul class="mb-4 font-extralight">
                        <li class="">
                ...
                <div class="w-full md:w-1/4 text-center md:text-left ">
                    <h5 class=" mb-6 font-bold">Rechtliches</h5>
                    <ul class="mb-4 font-extralight">
                        <li class="">
